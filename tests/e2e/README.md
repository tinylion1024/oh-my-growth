...
| # | 场景 | 核心问题 | 推荐模式 |
|---|------|----------|----------|
| 1 | SaaS冷启动 | 如何获取首批1000种子用户？ | assess + design |
| 2 | 电商复购 | 如何将复购率从15%提升到30%？ | design |
| 3 | 教育完课率 | 如何通过游戏化提升完课率？ | design + match |
| 4 | 内容社区活跃 | 如何激活5万用户中的沉睡用户？ | assess + design |
| 5 | 金融新功能推广 | 如何提升新功能渗透率？ | assess |
| 6 | 社交病毒传播 | 如何设计裂变降低CAC？ | design + match |
| 7 | B2B线索转化 | 如何优化线索到成单路径？ | audit |
| 8 | 订阅付费转化 | 如何提升付费转化率？ | assess + design |
| 9 | 本地生活商家冷启动 | 如何快速拓展1000家商家？ | design + match |
| 10 | 游戏长期留存 | 如何解决7日留存暴跌问题？ | audit + design |
