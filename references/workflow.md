...
**流程**：
```
Lead定位阶段/业务过程/北极星 → [Case, Weapon]检索 → [Growth, ROI, Skeptic]判断 → Lead排序 → Narrative输出
```
...
在进入任一模式前，优先用统一骨架理解问题：

1. **阶段判断**
   - 产品验证期：先找可复制主路径和核心价值成立证据
   - 增长放大期：先放大已验证动作并补齐漏斗与归因
   - 规模经营期：先平衡效率、收入质量和第二曲线
2. **业务过程判断**
   - 用户获取：关注新增、渠道、CAC、用户质量
   - 用户深耕：关注激活、留存、付费、LTV
3. **北极星与约束线**
   - 北极星：当前阶段最值得押注的核心指标
   - 约束线：不能被破坏的底线指标
...
详细定义见 [growth-operating-framework.md](growth-operating-framework.md)。
