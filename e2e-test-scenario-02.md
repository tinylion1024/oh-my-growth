...
**最该先解决**: 如何将复购率从15%提升到30%？

**理由**:
1. 知识库匹配到 2 个相关理论流派支撑
2. 当前阶段 '增长期(1-10)' 与问题高度相关
3. design 模式适合此类问题分析

**置信度**: 低

**第一个行动**: 使用 design 模式进行分析
...
### 资源详情
- **现有资源**: 月活10万 (estimated)
- **时间资源**: 3个月执行周期 (assumed)
- **技术资源**: MVP已就绪 (assumed)

### 关键事实
- product: 美妆电商 (observed)
- current_metric: 复购率15% (estimated)
