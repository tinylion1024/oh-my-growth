...
2. **问题诊断** → 再判断主目标、北极星指标、最大约束与最可能的主矛盾
3. **知识检索** → Case/Weapon/Theory Agent 检索最相关的案例、打法和理论
4. **优先级判断** → 用 ROI、执行复杂度、阶段匹配度和证据强度排序
5. **建议做 / 不做** → 明确指出当前该押注什么，不该分散到什么方向
6. **实验计划** → 输出最小实验、成功信号、停止信号和复盘节奏
